    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.labelContainer}>
          <Image source={require('./assets/vinho2.png')} style={styles.labelImage} />
          <Text style={styles.labelText}>Pergola</Text>
          <Text style={styles.labelText}>R$19,90</Text>
          <HorizontalMenu navigateTo={navigateTo} />
          <Text style={styles.labelText}>Tipo: Tinto</Text>
          <Text style={styles.labelText}>País: Brasil</Text>
          <Text style={styles.labelText}>Teor alcoólico: 10,2%</Text>
        </View>
      </View>
