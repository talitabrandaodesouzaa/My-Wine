    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.labelContainer}>
          <Image source={require('./assets/vinho1.png')} style={styles.labelImage} />
          <Text style={styles.labelText}>Sauvignon Blanc Reserva Seduce</Text>
          <Text style={styles.labelText}>R$66,90</Text>
          <HorizontalMenu navigateTo={navigateTo} />
          <Text style={styles.labelText}>Tipo: Branco</Text>
          <Text style={styles.labelText}>País: Chile</Text>
          <Text style={styles.labelText}>Teor alcoólico: 13,8%</Text>
        </View>
      </View>
