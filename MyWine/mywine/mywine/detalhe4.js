    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.labelContainer}>
          <Image source={require('./assets/vinho4.png')} style={styles.labelImage} />
          <Text style={styles.labelText}>Santa Rita 120 Reserva Pinot Noir</Text>
          <Text style={styles.labelText}>R$49,90</Text>
          <HorizontalMenu navigateTo={navigateTo} />
          <Text style={styles.labelText}>Tipo: Tinto</Text>
          <Text style={styles.labelText}>País: Chile</Text>
          <Text style={styles.labelText}>Teor alcoólico: 13,5%</Text>
        </View>
      </View>
